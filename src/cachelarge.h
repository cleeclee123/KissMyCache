...
template <typename T> class CacheLarge {
public:
  CacheLarge(size_t cacheSize, size_t blockSize, size_t ways)
    ...
    // replacing the bitset representation with size_t to store tags
